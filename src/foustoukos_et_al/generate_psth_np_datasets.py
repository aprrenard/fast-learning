...
yaml_file = r"C:\Users\aprenard\recherches\repos\fast-learning\docs\groups\imaging_rewarded.yaml"
...
# TODO read stop flag index from yaml file


# Stop flags GF actually used.
stop_flag_yaml = r"//sv-nas1.rcp.epfl.ch/Petersen-Lab/analysis/Anthony_Renard/mice_info/stop_flags/stop_flag_GF.yaml"
